...
class FieldParameters:
    ...
    base_data_path: str = 'my_favorite_data_path/E_omega_winding_number_map/'
...
def calculate_and_plot_winding_map(model_params: ModelParameters, field_params: FieldParameters):
    ...
    for omg_idx, omg in enumerate(omega_vals):
        ...
        data_path = f'{field_params.base_data_path}nt={field_params.nt}_k={field_params.num_k_points}/floquet_data_1D_2norbs_test_omega={omg:.5f}/'
