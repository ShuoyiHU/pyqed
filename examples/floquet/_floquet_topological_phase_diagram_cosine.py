...
def test_Gomez_Leon_2013(E0=200, number_of_step_in_b=11, nt=11, slice_b_value=None):
    """
    ...
    num_k = 500  # Reduced k values for faster testing
    ...
    for c in c_grid:
        for b_idx, b in enumerate(b_grid):
            ...
            data_path = f'MacBook_local_data/no_reassign_test/chiral_k={num_k:.1f}_nt_5_new/c={c:.4f}/floquet_data_Gomez_Leon_test_b={b:.2f}/'
        ...
        plt.tight_layout()
        save_dir = f'MacBook_local_data/no_reassign_test/chiral_k={num_k:.1f}_nt_5_new/c={c:.4f}_floquet_winding_map.png'
        abs_save_dir = f'MacBook_local_data/no_reassign_test/chiral_k={num_k:.1f}_nt_5_new/absolute_band_gap_map_c={c:.4f}_.png'
        rel_save_dir = f'MacBook_local_data/no_reassign_test/chiral_k={num_k:.1f}_nt_5_new/arelative_band_gap_map_c={c:.4f}.png'
        ...
        if slice_b_value is not None:
            ...
            slice_save_dir = 'MacBook_local_data/no_reassign_test/chiral/'
            ...
            slice_save_dir = 'MacBook_local_data/no_reassign_test/chiral_k=1000.0_nt_5_new/'
            os.makedirs(slice_save_dir, exist_ok=True)
...
def test_1D_2norbs(E0 = 0.5, number_of_step_in_omega = 11, nt = 101):
    ...
    for omg_idx, omg in enumerate(omega):
        ...
        floquet_model = tb_model.Floquet(omegad=omg, E0=E, nt=nt, polarization=[1], data_path=f'MacBook_local_data/E_omega_b=0.7_realistic_parameter_E_max_1_k=6_sin/floquet_data_1D_2norbs_test_omega={omg:.5f}/')
        energies, states = floquet_model.run(k_vals)
