...
L = 64
atom = f'H 0, 0, -3.6; H 0, 0, -{d}; H 0, 0, {d}; H 0, 0, 3.6'
# atom = f'H 0 0 -19; H 0 0 -17; H 0 0 -15; H 0 0 -13; H 0 0 -11; H 0 0 -9; H 0 0 -7; H 0 0 -5; H 0 0 -3; H 0 0 -1; H 0 0 1; H 0 0 3; H 0 0 5; H 0 0 7; H 0 0 9; H 0 0 11; H 0 0 13; H 0 0 15; H 0 0 17; H 0 0 19; H 0 0 21; H 0 0 23; H 0 0 25; H 0 0 27; H 0 0 29; H 0 0 31; H 0 0 33; H 0 0 35; H 0 0 37; H 0 0 39; '
...
plt.axhline(-26.0082020403144,  linestyle='--', label='STO-6G reference', color='r')
plt.axhline(-26.7253155130221,  linestyle='--', label='cc-pVDZ reference', color='g')
plt.legend()
plt.xlabel("M (number of contracted Gaussians kept per z slice)")
plt.ylabel("RHF total energy (Eh)")
plt.title(r"$H_{50}$ chain , $L_z$=(-64,64) RHF SCF energy vs M")
# plt.title(r"$H_{20}$ chain , $L_z$=(-30,30) RHF SCF energy vs M")
plt.grid(True)
plt.tight_layout()
plt.savefig(r"H50 chain RHF SCF energy vs M.png", dpi=2400, bbox_inches='tight', pad_inches=0.05)
